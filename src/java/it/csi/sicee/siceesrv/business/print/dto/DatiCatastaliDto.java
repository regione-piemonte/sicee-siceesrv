...
public class DatiCatastaliDto implements Serializable {
	...
	/**
	 * Gets the codice comune catastale.
	 *
	 * @return the codice comune catastale
	 */
	...
	/**
	 * Sets the codice comune catastale.
	 *
	 * @param subalterno the new codice comune catastale
	 */
