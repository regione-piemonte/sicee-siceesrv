...
/** 
 * This class represents the primary key of the SICEE_T_FABBISOGNO table.
 */
public class SiceeTFabbisognoPk implements Serializable
{
	/**
	 * 
	 */
	private static final long serialVersionUID = 8403966690719594028L;
	...
	/**
	 * Method 'SiceeTFabbisognoPk'
	 * 
	 */
	public SiceeTFabbisognoPk()
	{
	}
	 ...
	 * @param anno
	 */
	public SiceeTFabbisognoPk(final String idCertificatore, final String progrCertificato, final String anno)
	{
		this.idCertificatore = idCertificatore;
		this.progrCertificato = progrCertificato;
		this.anno = anno;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof SiceeTFabbisognoPk)) {
			return false;
		}
		
		final SiceeTFabbisognoPk _cast = (SiceeTFabbisognoPk) _other;
	...
	public String toString()
	{
		...
		ret.append( "it.csi.sicee.siceeweb.business.dao.dto.SiceeTFabbisognoPk: " );
