...
import it.csi.sicee.siceesrv.business.dao.dto.SiceeTRifIndex2015Pk;
...
public class SiceeTRifIndex2015DaoImpl extends AbstractDAO implements ParameterizedRowMapper<SiceeTRifIndex2015>, SiceeTRifIndex2015Dao
{
	...
	public SiceeTRifIndex2015Pk insert(SiceeTRifIndex2015 dto)
	{
		...
		jdbcTemplate.update("INSERT INTO " + getTableName() + " ( ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, FK_TIPO_DOC, NOME_FILE, UID_INDEX, HASH, ID_RIF_INDEX ) VALUES ( ?, ?, ?, ?, ?, ?, ?, ? )",dto.getIdCertificatore(),dto.getProgrCertificato(),dto.getAnno(),dto.getFkTipoDoc(),dto.getNomeFile(),dto.getUidIndex(),dto.getHash(),dto.getIdRifIndex());
		return dto.createPk();
	}
	...
	{
		jdbcTemplate.update("UPDATE " + getTableName() + " SET ID_CERTIFICATORE = ?, PROGR_CERTIFICATO = ?, ANNO = ?, FK_TIPO_DOC = ?, NOME_FILE = ?, UID_INDEX = ?, HASH = ?, ID_RIF_INDEX = ? WHERE ID_RIF_INDEX = ?",dto.getIdCertificatore(),dto.getProgrCertificato(),dto.getAnno(),dto.getFkTipoDoc(),dto.getNomeFile(),dto.getUidIndex(),dto.getHash(),dto.getIdRifIndex(),pk.getIdRifIndex());
	}
	...
	{
		try {
			List<SiceeTRifIndex2015> list = jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, FK_TIPO_DOC, NOME_FILE, UID_INDEX, HASH, ID_RIF_INDEX FROM " + getTableName() + " WHERE ID_RIF_INDEX = ?", this,idRifIndex);
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, FK_TIPO_DOC, NOME_FILE, UID_INDEX, HASH, ID_RIF_INDEX FROM " + getTableName() + " WHERE ID_CERTIFICATORE = ? AND PROGR_CERTIFICATO = ? AND ANNO = ?", this,idCertificatore,progrCertificato,anno);
		}
		catch (Exception e) {
			throw new SiceeTRifIndex2015DaoException("Query failed", e);
		}
	...
	{
		try {
			List<SiceeTRifIndex2015> list = jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, FK_TIPO_DOC, NOME_FILE, UID_INDEX, HASH, ID_RIF_INDEX FROM " + getTableName() + " WHERE ID_CERTIFICATORE = ? AND PROGR_CERTIFICATO = ? AND ANNO = ? AND FK_TIPO_DOC = ?", this,idCertificatore,progrCertificato,anno,fkTipoDoc);
			return list.size() == 0 ? null : list.get(0);
		}
		catch (Exception e) {
			throw new SiceeTRifIndex2015DaoException("Query failed", e);
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, FK_TIPO_DOC, NOME_FILE, UID_INDEX, HASH, ID_RIF_INDEX FROM " + getTableName() + " ORDER BY ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO", this);
		}
		catch (Exception e) {
			throw new SiceeTRifIndex2015DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, FK_TIPO_DOC, NOME_FILE, UID_INDEX, HASH, ID_RIF_INDEX FROM " + getTableName() + " WHERE FK_TIPO_DOC = ?", this,fkTipoDoc);
		}
		catch (Exception e) {
			throw new SiceeTRifIndex2015DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, FK_TIPO_DOC, NOME_FILE, UID_INDEX, HASH, ID_RIF_INDEX FROM " + getTableName() + " WHERE ID_CERTIFICATORE = ? ORDER BY ID_CERTIFICATORE", this,idCertificatore);
		}
		catch (Exception e) {
			throw new SiceeTRifIndex2015DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, FK_TIPO_DOC, NOME_FILE, UID_INDEX, HASH, ID_RIF_INDEX FROM " + getTableName() + " WHERE PROGR_CERTIFICATO = ? ORDER BY PROGR_CERTIFICATO", this,progrCertificato);
		}
		catch (Exception e) {
			throw new SiceeTRifIndex2015DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, FK_TIPO_DOC, NOME_FILE, UID_INDEX, HASH, ID_RIF_INDEX FROM " + getTableName() + " WHERE ANNO = ? ORDER BY ANNO", this,anno);
		}
		catch (Exception e) {
			throw new SiceeTRifIndex2015DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, FK_TIPO_DOC, NOME_FILE, UID_INDEX, HASH, ID_RIF_INDEX FROM " + getTableName() + " WHERE FK_TIPO_DOC = ? ORDER BY FK_TIPO_DOC", this,fkTipoDoc);
		}
		catch (Exception e) {
			throw new SiceeTRifIndex2015DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, FK_TIPO_DOC, NOME_FILE, UID_INDEX, HASH, ID_RIF_INDEX FROM " + getTableName() + " WHERE NOME_FILE = ? ORDER BY NOME_FILE", this,nomeFile);
		}
		catch (Exception e) {
			throw new SiceeTRifIndex2015DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, FK_TIPO_DOC, NOME_FILE, UID_INDEX, HASH, ID_RIF_INDEX FROM " + getTableName() + " WHERE UID_INDEX = ? ORDER BY UID_INDEX", this,uidIndex);
		}
		catch (Exception e) {
			throw new SiceeTRifIndex2015DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, FK_TIPO_DOC, NOME_FILE, UID_INDEX, HASH, ID_RIF_INDEX FROM " + getTableName() + " WHERE HASH = ? ORDER BY HASH", this,hash);
		}
		catch (Exception e) {
			throw new SiceeTRifIndex2015DaoException("Query failed", e);
		}
