...
/** 
 * This class represents the primary key of the SICEE_T_CONSUMI_EDIFICIO table.
 */
public class SiceeTConsumiEdificioPk implements Serializable
{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1194702298467978670L;
	...
	/**
	 * Method 'SiceeTConsumiEdificioPk'
	 * 
	 */
	public SiceeTConsumiEdificioPk()
	{
	}
	 ...
	 * @param anno
	 */
	public SiceeTConsumiEdificioPk(final String idCertificatore, final String progrCertificato, final String anno)
	{
		this.idCertificatore = idCertificatore;
		this.progrCertificato = progrCertificato;
		this.anno = anno;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof SiceeTConsumiEdificioPk)) {
			return false;
		}
		
		final SiceeTConsumiEdificioPk _cast = (SiceeTConsumiEdificioPk) _other;
	...
	public String toString()
	{
		...
		ret.append( "it.csi.sicee.siceeweb.business.dao.dto.SiceeTConsumiEdificioPk: " );
