...
/** 
 * This class represents the primary key of the SICEE_T_IMP_RISCALDAMENTO_ACS table.
 */
public class SiceeTImpRiscaldamentoAcsPk implements Serializable
{
	/**
	 * 
	 */
	private static final long serialVersionUID = -915441033992202873L;
	...
	/**
	 * Method 'SiceeTImpRiscaldamentoAcsPk'
	 * 
	 */
	public SiceeTImpRiscaldamentoAcsPk()
	{
	}
	 ...
	 * @param anno
	 */
	public SiceeTImpRiscaldamentoAcsPk(final String idCertificatore, final String progrCertificato, final String anno)
	{
		this.idCertificatore = idCertificatore;
		this.progrCertificato = progrCertificato;
		this.anno = anno;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof SiceeTImpRiscaldamentoAcsPk)) {
			return false;
		}
		
		final SiceeTImpRiscaldamentoAcsPk _cast = (SiceeTImpRiscaldamentoAcsPk) _other;
	...
	public String toString()
	{
		...
		ret.append( "it.csi.sicee.siceeweb.business.dao.dto.SiceeTImpRiscaldamentoAcsPk: " );
