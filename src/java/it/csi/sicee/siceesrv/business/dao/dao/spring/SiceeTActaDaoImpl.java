...
import it.csi.sicee.siceesrv.business.dao.dto.SiceeTActaPk;
...
public class SiceeTActaDaoImpl extends AbstractDAO implements ParameterizedRowMapper<SiceeTActa>, SiceeTActaDao
{
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, VOLUME, ID_DOC_ACTA, ID_CLASSIFICAZIONE_ACTA, TIPO_DOCUMENTO_ACTA, FAILED_STEP_ACTA, TIMESTAMP_ARCHIVIAZIONE, NUMERO_PROTOCOLLO, MAIL_INVIATA, TIMESTAMP_PROTOCOLLO, ID_PROTOCOLLO_ACTA FROM " + getTableName() + " WHERE ID_CERTIFICATORE = ? ORDER BY ID_CERTIFICATORE", this,idCertificatore);
		}
		catch (Exception e) {
			throw new SiceeTActaDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, VOLUME, ID_DOC_ACTA, ID_CLASSIFICAZIONE_ACTA, TIPO_DOCUMENTO_ACTA, FAILED_STEP_ACTA, TIMESTAMP_ARCHIVIAZIONE, NUMERO_PROTOCOLLO, MAIL_INVIATA, TIMESTAMP_PROTOCOLLO, ID_PROTOCOLLO_ACTA FROM " + getTableName() + " WHERE PROGR_CERTIFICATO = ? ORDER BY PROGR_CERTIFICATO", this,progrCertificato);
		}
		catch (Exception e) {
			throw new SiceeTActaDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, VOLUME, ID_DOC_ACTA, ID_CLASSIFICAZIONE_ACTA, TIPO_DOCUMENTO_ACTA, FAILED_STEP_ACTA, TIMESTAMP_ARCHIVIAZIONE, NUMERO_PROTOCOLLO, MAIL_INVIATA, TIMESTAMP_PROTOCOLLO, ID_PROTOCOLLO_ACTA FROM " + getTableName() + " WHERE ANNO = ? ORDER BY ANNO", this,anno);
		}
		catch (Exception e) {
			throw new SiceeTActaDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, VOLUME, ID_DOC_ACTA, ID_CLASSIFICAZIONE_ACTA, TIPO_DOCUMENTO_ACTA, FAILED_STEP_ACTA, TIMESTAMP_ARCHIVIAZIONE, NUMERO_PROTOCOLLO, MAIL_INVIATA, TIMESTAMP_PROTOCOLLO, ID_PROTOCOLLO_ACTA FROM " + getTableName() + " WHERE VOLUME = ? ORDER BY VOLUME", this,volume);
		}
		catch (Exception e) {
			throw new SiceeTActaDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, VOLUME, ID_DOC_ACTA, ID_CLASSIFICAZIONE_ACTA, TIPO_DOCUMENTO_ACTA, FAILED_STEP_ACTA, TIMESTAMP_ARCHIVIAZIONE, NUMERO_PROTOCOLLO, MAIL_INVIATA, TIMESTAMP_PROTOCOLLO, ID_PROTOCOLLO_ACTA FROM " + getTableName() + " WHERE ID_DOC_ACTA = ? ORDER BY ID_DOC_ACTA", this,idDocActa);
		}
		catch (Exception e) {
			throw new SiceeTActaDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, VOLUME, ID_DOC_ACTA, ID_CLASSIFICAZIONE_ACTA, TIPO_DOCUMENTO_ACTA, FAILED_STEP_ACTA, TIMESTAMP_ARCHIVIAZIONE, NUMERO_PROTOCOLLO, MAIL_INVIATA, TIMESTAMP_PROTOCOLLO, ID_PROTOCOLLO_ACTA FROM " + getTableName() + " WHERE ID_CLASSIFICAZIONE_ACTA = ? ORDER BY ID_CLASSIFICAZIONE_ACTA", this,idClassificazioneActa);
		}
		catch (Exception e) {
			throw new SiceeTActaDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, VOLUME, ID_DOC_ACTA, ID_CLASSIFICAZIONE_ACTA, TIPO_DOCUMENTO_ACTA, FAILED_STEP_ACTA, TIMESTAMP_ARCHIVIAZIONE, NUMERO_PROTOCOLLO, MAIL_INVIATA, TIMESTAMP_PROTOCOLLO, ID_PROTOCOLLO_ACTA FROM " + getTableName() + " WHERE TIPO_DOCUMENTO_ACTA = ? ORDER BY TIPO_DOCUMENTO_ACTA", this,tipoDocumentoActa);
		}
		catch (Exception e) {
			throw new SiceeTActaDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, VOLUME, ID_DOC_ACTA, ID_CLASSIFICAZIONE_ACTA, TIPO_DOCUMENTO_ACTA, FAILED_STEP_ACTA, TIMESTAMP_ARCHIVIAZIONE, NUMERO_PROTOCOLLO, MAIL_INVIATA, TIMESTAMP_PROTOCOLLO, ID_PROTOCOLLO_ACTA FROM " + getTableName() + " WHERE FAILED_STEP_ACTA = ? ORDER BY FAILED_STEP_ACTA", this,failedStepActa);
		}
		catch (Exception e) {
			throw new SiceeTActaDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, VOLUME, ID_DOC_ACTA, ID_CLASSIFICAZIONE_ACTA, TIPO_DOCUMENTO_ACTA, FAILED_STEP_ACTA, TIMESTAMP_ARCHIVIAZIONE, NUMERO_PROTOCOLLO, MAIL_INVIATA, TIMESTAMP_PROTOCOLLO, ID_PROTOCOLLO_ACTA FROM " + getTableName() + " WHERE TIMESTAMP_ARCHIVIAZIONE = ? ORDER BY TIMESTAMP_ARCHIVIAZIONE", this,timestampArchiviazione);
		}
		catch (Exception e) {
			throw new SiceeTActaDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, VOLUME, ID_DOC_ACTA, ID_CLASSIFICAZIONE_ACTA, TIPO_DOCUMENTO_ACTA, FAILED_STEP_ACTA, TIMESTAMP_ARCHIVIAZIONE, NUMERO_PROTOCOLLO, MAIL_INVIATA, TIMESTAMP_PROTOCOLLO, ID_PROTOCOLLO_ACTA FROM " + getTableName() + " WHERE NUMERO_PROTOCOLLO = ? ORDER BY NUMERO_PROTOCOLLO", this,numeroProtocollo);
		}
		catch (Exception e) {
			throw new SiceeTActaDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, VOLUME, ID_DOC_ACTA, ID_CLASSIFICAZIONE_ACTA, TIPO_DOCUMENTO_ACTA, FAILED_STEP_ACTA, TIMESTAMP_ARCHIVIAZIONE, NUMERO_PROTOCOLLO, MAIL_INVIATA, TIMESTAMP_PROTOCOLLO, ID_PROTOCOLLO_ACTA FROM " + getTableName() + " WHERE MAIL_INVIATA = ? ORDER BY MAIL_INVIATA", this,mailInviata);
		}
		catch (Exception e) {
			throw new SiceeTActaDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, VOLUME, ID_DOC_ACTA, ID_CLASSIFICAZIONE_ACTA, TIPO_DOCUMENTO_ACTA, FAILED_STEP_ACTA, TIMESTAMP_ARCHIVIAZIONE, NUMERO_PROTOCOLLO, MAIL_INVIATA, TIMESTAMP_PROTOCOLLO, ID_PROTOCOLLO_ACTA FROM " + getTableName() + " WHERE TIMESTAMP_PROTOCOLLO = ? ORDER BY TIMESTAMP_PROTOCOLLO", this,timestampProtocollo);
		}
		catch (Exception e) {
			throw new SiceeTActaDaoException("Query failed", e);
		}
	...
	/** 
	 * Returns all rows from the SICEE_T_ACTA table that match the criteria 'ID_PROTOCOLLO_ACTA = :idProtocolloActa'.
	 */
	
	public List<SiceeTActa> findWhereIdProtocolloActaEquals(String idProtocolloActa) throws SiceeTActaDaoException
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, VOLUME, ID_DOC_ACTA, ID_CLASSIFICAZIONE_ACTA, TIPO_DOCUMENTO_ACTA, FAILED_STEP_ACTA, TIMESTAMP_ARCHIVIAZIONE, NUMERO_PROTOCOLLO, MAIL_INVIATA, TIMESTAMP_PROTOCOLLO, ID_PROTOCOLLO_ACTA FROM " + getTableName() + " WHERE ID_PROTOCOLLO_ACTA = ? ORDER BY ID_PROTOCOLLO_ACTA", this,idProtocolloActa);
		}
		catch (Exception e) {
			throw new SiceeTActaDaoException("Query failed", e);
		}
