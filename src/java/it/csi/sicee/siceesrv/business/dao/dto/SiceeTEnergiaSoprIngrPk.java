...
/** 
 * This class represents the primary key of the SICEE_T_ENERGIA_SOPR_INGR table.
 */
public class SiceeTEnergiaSoprIngrPk implements Serializable
{
	/**
	 * 
	 */
	private static final long serialVersionUID = 6423069755685652311L;
	...
	/**
	 * Method 'SiceeTEnergiaSoprIngrPk'
	 * 
	 */
	public SiceeTEnergiaSoprIngrPk()
	{
	}
	 ...
	 * @param anno
	 */
	public SiceeTEnergiaSoprIngrPk(final String idCertificatore, final String progrCertificato, final String anno)
	{
		this.idCertificatore = idCertificatore;
		this.progrCertificato = progrCertificato;
		this.anno = anno;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof SiceeTEnergiaSoprIngrPk)) {
			return false;
		}
		
		final SiceeTEnergiaSoprIngrPk _cast = (SiceeTEnergiaSoprIngrPk) _other;
	...
	public String toString()
	{
		...
		ret.append( "it.csi.sicee.siceeweb.business.dao.dto.SiceeTEnergiaSoprIngrPk: " );
