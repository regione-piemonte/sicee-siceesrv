...
/** 
 * This class represents the primary key of the SICEE_T_DATI_ENER_2015 table.
 */
public class SiceeTDatiEner2015Pk implements Serializable
{
	 ...
	 * @param anno
	 */
	public SiceeTDatiEner2015Pk(final String idCertificatore, final String progrCertificato, final String anno)
	{
		this.idCertificatore = idCertificatore;
		this.progrCertificato = progrCertificato;
		this.anno = anno;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof SiceeTDatiEner2015Pk)) {
			return false;
		}
		
		final SiceeTDatiEner2015Pk _cast = (SiceeTDatiEner2015Pk) _other;
	...
	public String toString()
	{
		...
		ret.append( "it.csi.sicee.siceeweb.business.dao.dto.SiceeTDatiEner2015Pk: " );
