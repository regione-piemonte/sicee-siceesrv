...
/** 
 * This class represents the primary key of the SICEE_T_CLASSE_ENERGETICA table.
 */
public class SiceeTClasseEnergeticaPk implements Serializable
{
	/**
	 * 
	 */
	private static final long serialVersionUID = 5311107820017684432L;
	...
	/**
	 * Method 'SiceeTClasseEnergeticaPk'
	 * 
	 */
	public SiceeTClasseEnergeticaPk()
	{
	}
	 ...
	 * @param anno
	 */
	public SiceeTClasseEnergeticaPk(final String idCertificatore, final String progrCertificato, final String anno)
	{
		this.idCertificatore = idCertificatore;
		this.progrCertificato = progrCertificato;
		this.anno = anno;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof SiceeTClasseEnergeticaPk)) {
			return false;
		}
		
		final SiceeTClasseEnergeticaPk _cast = (SiceeTClasseEnergeticaPk) _other;
	...
	public String toString()
	{
		...
		ret.append( "it.csi.sicee.siceeweb.business.dao.dto.SiceeTClasseEnergeticaPk: " );
